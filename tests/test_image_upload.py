...
class TestImageUpload:
    ...
    def test_upload_jpg_image(self, logged_in_client, app):
    ...
    def test_upload_jpeg_image(self, logged_in_client, app):
    ...
    def test_upload_gif_image(self, logged_in_client, app):
    ...
    def test_upload_webp_image(self, logged_in_client, app):
    ...
    def test_upload_invalid_file_type_txt(self, logged_in_client):
    ...
    def test_upload_invalid_file_type_pdf(self, logged_in_client):
    ...
    def test_upload_invalid_file_type_exe(self, logged_in_client):
    ...
    def test_upload_creates_unique_filenames(self, logged_in_client):
        ...
        response1 = logged_in_client.post('/api/upload',
                               data=data1,
                               content_type='multipart/form-data')
        response2 = logged_in_client.post('/api/upload',
                               data=data2,
                               content_type='multipart/form-data')
    ...
    def test_upload_file_case_insensitive_extension(self, logged_in_client):
...
class TestImageListing:
    ...
    def test_list_images_after_upload(self, logged_in_client, app):
        """Test listing images after uploading one."""
        # Upload an image first
        data = {
            'image': (io.BytesIO(b'test image'), 'test.png')
        }
        upload_response = logged_in_client.post('/api/upload',
                                     data=data,
                                     content_type='multipart/form-data')
        assert upload_response.status_code == 200

        # Now list images
        list_response = logged_in_client.get('/api/images')
    ...
    def test_list_images_multiple_uploads(self, logged_in_client, app):
    ...
    def test_list_images_sorted_by_newest(self, logged_in_client, app):
        ...
        for i in range(3):
            ...
            logged_in_client.post('/api/upload',
                       data=data,
                       content_type='multipart/form-data')
            time.sleep(0.01)  # Small delay to ensure different timestamps

        # List images
        response = logged_in_client.get('/api/images')
        json_data = response.get_json()
